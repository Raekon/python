...
class print_up(object):
    ...
    def printit(self):
        ...
        if preview_choice=="200":
            ...
            preview="-p '400,400,200,200'"
        elif preview_choice=="800":
            preview="-p '800,800,200,200'"
        ...
        if self.media==0:         #photo chosen
            ...
            cmd="raspivid -w {0} -h {1} -t {2} -fps {3} -b {4} {5} -ts  -o /home/pi/Videos/{6}%d.h264".format(self.picture_width,self.picture_height,minutes,self.timelapse.value, bitrate,preview,filename)     
        print (cmd)
